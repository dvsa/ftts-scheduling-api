...
export const listOfInvalidSlots = [{
  testCentreId: '123',
  testTypes: [
    'CAR',
  ],
...
},
{
  ...
  startDateTime: '2020-06-30',
  quantity: 5,
}];

export const listPayloadWithInvalidSlots = [
  ...listPayload,
  ...listOfInvalidSlots];
...
export const mockTCNErrorResponse = (errorStatus: number, headers?: { [key: string]: string | number }, message?: string): MockErrorResponse => ({
  response: {
    status: errorStatus,
    headers,
    data: {
